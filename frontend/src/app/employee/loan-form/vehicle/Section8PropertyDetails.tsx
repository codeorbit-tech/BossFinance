      ...
      <div className="bg-accent/5 border border-accent/20 rounded-2xl p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-accent/10 flex items-center justify-center">
            <span className="material-symbols-outlined text-accent text-xl">payments</span>
          </div>
          <div>
            <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Requested Loan Amount</p>
            <p className="text-lg font-black text-on-surface">{formatCurrency(formData.loanDetails.loanAmount)}</p>
          </div>
        </div>
        <div className="text-right">
          <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Tenure</p>
          <p className="font-bold text-on-surface">{formData.loanDetails.tenure || '0'} Months</p>
        </div>
      </div>
